  ...
  return (
    <Container>
      ...
      <P>
        ...
        is committed to protecting your privacy. It is our policy to respect
        your privacy and comply with any applicable laws and regulations
        regarding any personal information we may collect about you, including
        across our website, portalbridge.com, and other sites we own and operate
        (collectively, the “Platform”). This Privacy Policy (the "Policy")
        outlines the data collection, processing, and management practices of
        the Company in relation to services provided on the Platform (the
        “Services”). By using our Platform, you agree to the collection, use,
      ...
      <P>
        ...
        privacy policies. After following a link to any third-party content, you
        should read their posted privacy policy information about how they
        collect and use personal information. This Privacy Policy does not apply
        to any of your activities after you leave our Platform.
      </P>
      <ol type="I">
        <H2>
        ...
        <ol type="A">
          ...
          <div>
            <P>
              ...
              information directly (for example, details you connect your wallet
              to the Platform), and we will store that personal information on
              our systems and process it for the purposes described in this
              Privacy Policy.
            </P>
            <P>
              Depending on the Service, the personal information we collect will
              be relevant to providing that Service and include some or all of
              the following non-personally identifiable data:
            </P>
            <P>
              <ul>
          ...
          <div>
            <P>
              Information you generate while using our Services may be retained
              to protect the safety and well-being of our users; to protect our
              rights and property in connection with our Services; to conduct
              research; to operate, improve, personalize, and optimize our
              Services and our users’ experiences, including through the use of
              analytics; and to manage and deliver advertising. Where required
              by law, we will seek your consent for this.
            </P>
          </div>
          <H3>
            <TitleItem>
        ...
        <H2>
          <TitleItem>PROCESSING AND USE OF YOUR PERSONAL INFORMATION</TitleItem>
        </H2>
        <div>
          <P>
        ...
        <div>
          <P>
            We share your personal data with our third-party service providers,
            agents, subcontractors and other associated organizations, our group
            companies, and affiliates (as described below) in order to complete
            tasks and provide the Platform and Services to you on our behalf.
            When using third party service providers, they are required to
        ...
        <div>
          <P>
            ...
            protect the security of your information both online and offline and
            to ensure that your data is treated securely and in accordance with
            this Privacy Policy. These measures vary based upon the sensitivity
            of your information. It is important that you protect and maintain
            the security of your personal information, including the secure
            storage of any keys or other wallet data used to access your crypto
            assets.
          </P>
          <P>
            While we take precautions against possible security breaches of our
            Services and our customer databases and records, no website or
            Internet transmission is completely secure. We cannot guarantee that
            unauthorized access, hacking, data loss, or other breaches will
            never occur, and we cannot guarantee the security of your
        ...
        <div>
          <P>
            ...
            collected it and how we use it, but we will not retain your personal
            information for longer than is necessary to provide you with the
            Services or for our legal requirements.
          </P>
          <P>
            ...
            that we may retain some information after you have ceased to use the
            Platform’s Services where necessary to enable us to meet our legal
            obligations or to exercise, defend, or establish our rights.
          </P>
        </div>
        ...
        <div>
          <P>
            ...
            your use of our Platform or the products and/or services offered on
            or through it. You may also request details of the personal
          ...
          <P>
            ...
            details below. To unsubscribe from our email database or opt-out of
          ...
          <P>
            ...
            manifestly unfounded or excessive. Alternatively, we could refuse to
          ...
          <P>
            ...
            <br />
            Notwithstanding the above, we cannot edit or delete any information
            that is stored on a blockchain as we do not have custody or control
            over any blockchains. The information stored on the blockchain may
            include purchases, sales, and transfers related to any blockchain
            address associated with you.
          </P>
        </div>
        ...
        <div>
          <P>
            ...
            believe your child has uploaded personal information to our Platform
            without your consent, you may contact us. If we become aware that a
            child has provided us with personal information in violation of
        ...
        <div>
          <P>
            ...
            which may have data protection laws that are different from the laws
            where you live. We endeavor to safeguard your information consistent
        ...
        <div>
          <P>
            Our Platform may link to external sites that are not operated by us.
        ...
        <div>
          <P>
            ...
            are accessing this Policy, and if the changes are significant, or if
            required by applicable law, we will contact you (based on your
            selected preferences for communications from us) with details of the
            changes.
          </P>
          <P>
        ...
        <div>
          <P>
            ...
            categories of personal information we have collected about them, and
            whether we disclosed that personal information for a business
        ...
        <div>
          <P>
            ...
            right by contacting us with the subject line “Nevada Do Not Sell
        ...
        <div>
          <P>
            ...
            Regulation or ‘GDPR’). You can find out more about the GDPR and your
        ...
        <div>
          <P>
            ...
            Policy or our data collection and processing practices, or if you
            want to report any security violations to us, or exercise any of
            your rights under this Privacy Policy, please contact us at the
            following address:
          </P>
          <br />
