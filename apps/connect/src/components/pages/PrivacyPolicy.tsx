...
const PrivacyPolicies = () => {
  ...
  return (
    <Container>
      ...
      <ol type="I">
        <H2><TitleItem>INFORMATION WE COLLECT</TitleItem></H2>
        <ol type="A">
          <H3><TitleItem>Information About You That You Share With Us Directly</TitleItem></H3>
          <div>
            <P>When you use Services on the Platform you may give us personal information directly (for example, details you connect your wallet to the Platform), and we will store that personal information on our systems and process it for the purposes described in this Privacy Policy.</P>
            <P>Depending on the Service, the personal information we collect will be relevant to providing that Service and include some or all of the following non-personally identifiable data:</P>
            <P>
              <ul>
                <li>Your public blockchain wallet address;</li>
                <li>Amount of any asset involved in a transaction; and</li>
                <li>Any additional information required for verification or participation in the Service offered.</li>
              </ul>
            </P>
            <P>We may also collect personal information from you when you communicate with us, such as your name, email address, and any other information you voluntarily provide.</P>
          </div>
          <H3><TitleItem>Information You Generate Using Our Services</TitleItem></H3>
          <div>
            <P>Information you generate while using our Services may be retained to protect the safety and well-being of our users; to protect our rights and property in connection with our Services; to conduct research; to operate, improve, personalize, and optimize our Services and our users’ experiences, including through the use of analytics; and to manage and deliver advertising. Where required by law, we will seek your consent for this.</P>
          </div>
          <H3><TitleItem>Cookies and Other Automated Information Collection</TitleItem></H3>
          <div>
            <P>We use cookies and other similar technologies (e.g., beacons, pixel tags, clear gifs, and device identifiers). We, our service providers, and our business partners use these cookies and other similar technologies to process information, which may include:</P>
            <P>
              <ul>
                <li>IP address;</li>
                ...
                <li>your mobile device’s identifiers, like your MAC Address, Apple Identifier For Advertising (IDFA), and/or Android Advertising ID (AAID);</li>
                ...
                <li>what your current progress is in our Services and the date and time of activity.</li>
              </ul>
            </P>
        ...
        <H2><TitleItem>PROCESSING AND USE OF YOUR PERSONAL INFORMATION</TitleItem></H2>
        <div>
          <P>We only collect and use your personal information when we have a legitimate reason for doing so. Most commonly, we will use your personal data in the following circumstances:</P>
          <P>
            <ul>
              <li>Provide our Services and create accounts in those Services</li>
              <li>Monitor and maintain the security and integrity of our Platform</li>
              <li>Improve, optimize and personalize our Services and our user’s experiences</li>
              <li>Communicate with you about the Services you are using</li>
              <li>Customer service and managing user communications, including technical support</li>
              <li>Protect the safety and well-being of our users and others</li>
              <li>Where you provide sensitive or special category personal information to us</li>
              <li>Maintain our business operations, including any business transition, like a merger, acquisition by another company, or sale of all or part of our assets</li>
              <li>For security purposes and to prevent fraud or potentially illegal activities, and to enforce the applicable Terms of Service</li>
              <li>Cooperate with public authorities and law enforcement where lawfully permitted or required</li>
              <li>Protect our rights, including compliance with applicable legal obligations, resolving any disputes we may have, and to administer our agreements with third parties</li>
            </ul>
          </P>

        </div>

        <H2><TitleItem>DISCLOSURE OF PERSONAL INFORMATION TO THIRD PARTIES</TitleItem></H2>
        <div>
          ...
          <P>
            <ul>
              ...
              <li>third parties, including agents or sub-contractors, who assist us in providing information, products, or services</li>
              <li>third parties to collect and process data</li>
              <li>an entity that buys, or to which we transfer all or substantially all of our assets and business</li>
            </ul>
          </P>
        </div>
        <H2><TitleItem>SECURITY OF YOUR PERSONAL INFORMATION</TitleItem></H2>
        <div>
          <P>We implement reasonable and appropriate security measures to help protect the security of your information both online and offline and to ensure that your data is treated securely and in accordance with this Privacy Policy. These measures vary based upon the sensitivity of your information. It is important that you protect and maintain the security of your personal information, including the secure storage of any keys or other wallet data used to access your crypto assets.</P>
        ...
        <H2><TitleItem>HOW LONG WE KEEP YOUR PERSONAL INFORMATION</TitleItem></H2>
        <div>
          <P>How long we retain your personal information depends on why we collected it and how we use it, but we will not retain your personal information for longer than is necessary to provide you with the Services or for our legal requirements.</P>
          <P>We will retain personal information that is connected with your account and/or the Services you use from us for as long as you are actively using Services on the Platform. However, you acknowledge that we may retain some information after you have ceased to use the Platform’s Services where necessary to enable us to meet our legal obligations or to exercise, defend, or establish our rights.</P>
        </div>

        <H2><TitleItem>YOUR RIGHTS AND CONTROLLING YOUR PERSONAL INFORMATION</TitleItem></H2>
        <div>
          <P>
          ...
          <P><b>Marketing permission and Unsubscribing:</b> If you have previously agreed to us using your personal information for direct marketing purposes, you may change your mind at any time by opting out of the promotional communications or contacting us using the details below. To unsubscribe from our email database or opt-out of communications (including marketing communications), please contact us using the details provided in this privacy policy or opt-out using the opt-out facilities provided in the communication. We may need to request specific information from you to help us confirm your identity.</P>
          ...
          <P><b>Non-discrimination:</b> We will not discriminate against you for exercising any of your rights over your personal information. Unless your personal information is required to provide you with a particular service or offer (for example providing user support), we will not deny you goods or services and/or charge you different prices or rates for goods or services, including through granting discounts or other benefits, or imposing penalties, or provide you with a different level or quality of goods or services.</P>
          ...
          <P><b>Period for replying to a legitimate request:</b> We try to respond to all legitimate requests within one month. Occasionally it may take us longer than a month if your request is particularly complex or you have made a number of requests. In this case, we will notify you and keep you updated.
            <br />
        ...
        <H2><TitleItem>INTERNATIONAL TRANSFERS</TitleItem></H2>
        <div>
          <P>All information processed by us may be transferred, processed, and stored anywhere in the world, including, but not limited to, the United States, members of the European Union, or other countries, which may have data protection laws that are different from the laws where you live. We endeavor to safeguard your information consistent with the requirements of applicable laws.</P>
        </div>

        <H2><TitleItem>LIMITS OF OUR POLICY</TitleItem></H2>
        <div>
          <P>Our Platform may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites and cannot accept responsibility or liability for their respective privacy practices.</P>
        </div>

        <H2><TitleItem>CHANGES TO THIS POLICY</TitleItem></H2>
        <div>
          <P>At our discretion, we may change this Privacy Policy to reflect updates to our business processes, current acceptable practices, or legislative or regulatory changes. If we decide to change this Policy, we will post the changes here at the same link by which you are accessing this Policy, and if the changes are significant, or if required by applicable law, we will contact you (based on your selected preferences for communications from us) with details of the changes.</P>
        ...
        <H2><TitleItem>SUPPLEMENTAL NOTICE FOR CALIFORNIA RESIDENTS</TitleItem></H2>
        <div>
          <P>This Supplemental Notice for California Residents only applies to our processing of personal information that is subject to the California Consumer Privacy Act of 2018 (the “<b>CCPA</b>”). The CCPA provides California residents with the right to know what categories of personal information we have collected about them, and whether we disclosed that personal information for a business purpose (e.g., to a service provider) in the preceding 12 months. California residents can find this information by visiting: <Link href="https://www.oag.ca.gov/privacy/ccpa" target="_blank">https://www.oag.ca.gov/privacy/ccpa</Link>.</P>
        </div>

        <H2><TitleItem>SUPPLEMENTAL NOTICE FOR NEVADA RESIDENTS </TitleItem></H2>
        <div>
          <P>If you are a resident of Nevada, you have the right to opt-out of the sale of certain personal information to third parties who intend to license or sell that personal information. You can exercise this right by contacting us with the subject line “Nevada Do Not Sell Request” and providing us with your name and the email address associated with your account. </P>
        </div>

        <H2><TitleItem>YOUR RIGHTS AS A DATA SUBJECT (GDPR)</TitleItem></H2>
        <div>
          <P>You have certain rights under applicable legislation, and in particular under Regulation EU 2016/679 (General Data Protection Regulation or ‘GDPR’). You can find out more about the GDPR and your rights by accessing the European Commission’s website.</P>
        </div>
        <H2><TitleItem>CONTACT US FOR QUESTIONS AND REPORTING VIOLATIONS</TitleItem></H2>
        <div>
          <P>If you have any questions, concerns, or complaints about our Privacy Policy or our data collection and processing practices, or if you want to report any security violations to us, or exercise any of your rights under this Privacy Policy, please contact us at the following address:</P>
          <br />
