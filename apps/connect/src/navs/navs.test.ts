...
describe('navs', () => {
    ...
    it('should update the URL when a transfer starts with a permlink', () => {
        ...
        expect(global.window.history.pushState).toHaveBeenCalledWith({ event: 'transfer.start' }, 'Start Transfer', '?sourceChain=bsc&transactionId=txId');
    });
    ...
    it('should clear the URL when an automatic transfer success', () => {
        ...
        expect(global.window.history.pushState).toHaveBeenCalledWith({ event: 'transfer.success' }, 'Transfer Success', '/');
    });
    ...
    it('should clear the URL when an redeemed transfer success', () => {
        ...
        expect(global.window.history.pushState).toHaveBeenCalledWith({ event: 'transfer.redeem.success' }, 'Transfer Success', '/');
    });
});