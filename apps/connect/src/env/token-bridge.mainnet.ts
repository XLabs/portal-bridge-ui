import {
  ...
  MORE,
  SEI,
  wormholeConnectConfig as wormholeConnectConfigBase,
} from "./token-bridge";
...
console.log('MAAAAAIIINNNNN')
export const wormholeConnectConfig = mergeTruthy<WormholeConnectConfig>(
  wormholeConnectConfigBase,
  {
    moreNetworks: {
