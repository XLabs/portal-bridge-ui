...
import { NavBarType } from "../../utils/constants";
...
interface NavBarProps {
  baseUrl?: string;
  navBar: NavBarType[];
  env: "testnet" | "mainnet" | "devnet";
}

export const NavBar = ({ baseUrl, navBar, env }:  NavBarProps) => {
          ...
          <LinkContainer>
            {[
              ...navBar,
              {
                ...
                isBlank: true,
                active: false,
                href: `https://wormholescan.io${env === "testnet" ? "/#/?network=TESTNET" : ""}`,
              },
