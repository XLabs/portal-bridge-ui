...
export const WalletManager = () => {
  ...
  const text = isConnected ? (ensName ? truncateEns(ensName) : (address ? truncateAddr(address): "")) : "CONNECT WALLET"
  return (
    <div className="
    ...
    >
      {blockie ? <img className="w-4 h-4 rounded-full" src={blockie} /> : <LightningIcon/>}
