...
const Parsers: ErrorParser[] = [
  {
    apply: (e: any) => isString(e?.data?.message) && e?.data?.message?.startsWith(MM_ERR_WITH_INFO_START),
...
const parseError = (e: any): string => (Parsers.find(({ apply = () => true }) => apply(e)) || DefaultParser).value(e);
