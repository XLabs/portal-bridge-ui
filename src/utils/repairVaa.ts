import { parseVaa, GuardianSignature, keccak256, hexToUint8Array } from "@certusone/wormhole-sdk";
...
export function repairVaa(
    ...
    parsedVaa.guardianSignatures.forEach((signature) => {
        try {
            ...
            if (currentGuardianPublicKey.toLowerCase() === vaaGuardianPublicKey.toLowerCase()) {
